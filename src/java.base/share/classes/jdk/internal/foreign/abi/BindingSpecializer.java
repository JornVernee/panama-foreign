...
public class BindingSpecializer {
    ...
    private static final MethodTypeDesc MTD_CLASS_DATA = MethodTypeDesc.of(CD_Object, CD_MethodHandles_Lookup, CD_String, CD_Class);
    ...
    private static final ConstantDesc BSM_CLASS_DATA = DynamicConstantDesc.of(
    ...
    private void specialize() {
        ...
        if (callingSequence.forDowncall()) {
            cb.constantInstruction(BSM_CLASS_DATA);
        } else {
